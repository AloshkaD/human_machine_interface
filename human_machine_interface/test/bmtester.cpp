/*!*******************************************************************************************
 *  \file       bmtester.cpp
 *  \brief      bmtester definition file.
...
#include "../include/human_machine_interface/BMTester.h"
#include <stdlib.h>
 ...
 *
 *********************************************************************************************************************/
bmtester::bmtester(QObject *parent)
{
 ...
 *
 *********************************************************************************************************************/
void bmtester::setTimerInterval(double ms)
{
 ...
 *
 *********************************************************************************************************************/
void bmtester::timerEvent(QTimerEvent *e){
    int error = rand()%25;
    switch(error)
    {
      case 1:
      supervisorMessage.text="Behaviour 1";
      supervisorMessage.process="take-off";
      supervisorMessage.topic="";
      break;

      case 2:
      supervisorMessage.text="Behaviour 2";
      supervisorMessage.process="hover";
      supervisorMessage.topic="";
      break;

      case 3:
      supervisorMessage.text="Behaviour 3";
      supervisorMessage.process="move";
      supervisorMessage.topic="";
      break;

      case 4:
      supervisorMessage.text="Behaviour 4";
      supervisorMessage.process="land";
      supervisorMessage.topic="";
