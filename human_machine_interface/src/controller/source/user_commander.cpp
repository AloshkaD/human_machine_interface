...
*****************************************************************************/
 ...
 UserCommander:: UserCommander(){}
  ...
  void UserCommander::openPublications(ros::NodeHandle nodeHandle){
     ...
     dronePositionReferencePublisher = nodeHandle.advertise<droneMsgsROS::dronePositionRefCommandStamped>(ros::this_node::getNamespace() + "/" + drone_position_refs, 1);
     droneYawReferencePublisher = nodeHandle.advertise<droneMsgsROS::droneYawRefCommand>(ros::this_node::getNamespace() + "/" + drone_controller_yaw_ref_command, 1);

     droneManagerStatusSubs  = nodeHandle.subscribe(drone_manager_status, 1, &UserCommander::droneCurrentManagerStatusSubCallback,this);
